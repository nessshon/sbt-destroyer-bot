...
class Manager:
    ...
    def __init__(self, data: Dict[str, Any]) -> None:
        ...
        self.language_code: str = data.get("language_code", self.user.language_code)

        self.text_button: TextButton = TextButton(self.language_code)
        self.text_message: TextMessage = TextMessage(self.language_code)

        self.tonapi: AsyncTonapi = data.get("tonapi")
        self.account_wallet: AccountWallet = data.get("account_wallet")
